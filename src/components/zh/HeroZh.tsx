    ...
    <section className="relative flex items-center justify-start overflow-hidden min-h-[640px] lg:min-h-[calc(100vh-80px)] h-auto w-full bg-brand-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] w-full px-6 sm:px-12 md:px-20 py-20 sm:py-28 lg:pt-36 lg:pb-32">
        <div className="fade-in-section">
          ...
          {/* Main Copy */}
          <h1 className="max-w-[860px] font-serif text-[1.5rem] sm:text-3xl lg:text-4xl xl:text-[3rem] font-medium tracking-wide text-brand-navy leading-[1.4] mb-8 sm:mb-12">
            <span className="block mb-2">日本法人のブラックボックスを排除する。</span>
            <span className="block">海外本社のための『完全透明な』</span>
            <span className="block">経理・財務インフラ</span>
          </h1>
          ...
          <div className="relative pl-6 sm:pl-10 mb-10 sm:mb-12 max-w-[620px] flex flex-col gap-6 sm:gap-8">
            ...
            <div className="flex items-start gap-4 sm:gap-5">
              ...
              <p className="text-base sm:text-[1.1rem] text-brand-slate leading-[1.8] tracking-wide">
                Luare Consultingは、貴社の『駐日経営管家（カントリーマネージャー代行）』として、極めて透明性の高い現地経営管理とリスクコントロール支援を提供します。
              </p>
            </div>
          </div>
